  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      images.forEach((imgObj) => {
        submitData.append("images", imgObj.file);
      });
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.msg || "Failed to submit donation");
      }
      ...
      <div className="border border-gray-300 rounded-lg p-6 shadow-md bg-white">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-900">
            List an Item to Donate
          </h2>
          <p className="text-gray-600 mt-1">
            Help someone in need by donating items you no longer need. Share
            your abundance! ❤️
          </p>
        </div>
